...
sub render {
  ...
  my $html = qq{<form action="$search_url" method="GET"><div class="search" style="width: 420px; border: 1px solid lightgrey"><input type="hidden" name="site" value="ensemblthis" /><input type="hidden" name="filter_species" value="$species_name" /><input type="text" id="q" name="q" class="query" style="width: 380px" placeholder="Search $species_name&hellip;" /><input type="submit" value="1"/></div></form>};
