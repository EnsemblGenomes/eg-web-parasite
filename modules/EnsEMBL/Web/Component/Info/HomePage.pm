...
sub _navlinks_text {
  ...
  if (-e "$SiteDefs::ENSEMBL_SERVERROOT/eg-web-parasite/htdocs/expression/$species/index.html") {
    my $studies_page_url = (split '/', $species_defs->species_path)[0] . '/expression/' . $species;
