...
### Override Consent.pm in public-plugins.
### Component for page asking user to consent to GDPR Parasite account privacy policy
...
sub content {
  ...
  my $url     = $hub->species_defs->GDPR_ACCOUNT_URL;
