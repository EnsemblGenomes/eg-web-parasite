...
# writes to STDOUT
# Run from dev machine: perl -I ensembl-taxonomy/modules/ -I ensembl/modules/ eg-web-parasite/utils/biomart_taxon_tree.pl --host xxxx --port xxxx --user xxxx --biomart_db parasite_mart_13 > eg-web-parasite/htdocs/taxon_tree_data.js  
#
use JSON qw/to_json/;
use Getopt::Long;
use DBI;
